...
[`docs/screenshots/`](docs/screenshots/) — see that folder's README for the
exact files to capture if any image below is missing.
...
![SaaS Console — Templates](docs/screenshots/console-templates.png)
...
![SaaS Console — Customers](docs/screenshots/console-customers.png)
...
![SaaS Console — Instances](docs/screenshots/console-instances.png)

**4. Metering** — per-customer usage: tokens and calls over time (daily / weekly
/ monthly) plus a breakdown by instance.

![SaaS Console — Metering](docs/screenshots/console-metering.png)
...
![SaaS Console — Costs](docs/screenshots/console-costs.png)
...
![Customer chat — welcome](docs/screenshots/customer-welcome.png)
...
![Customer chat — grounded answer](docs/screenshots/customer-answer.png)
